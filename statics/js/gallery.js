        ...
        */
        ...
        function galleryInit( elementPos ) {
            ...
            if( galleryActive == false ) {
                ...
                $( 'body' ).append( '<div id="gallery-popup"><div class="gallery-popup-background"></div><div class="gallery-popup-content"><div class="gallery-popup-close-button"><i class="icon-remove"></i></div><div class="gallery-popup-prev-image"><i class="icon-chevron-left"></i></div><div class="gallery-popup-next-image"><i class="icon-chevron-right"></i></div></div></div>' );
